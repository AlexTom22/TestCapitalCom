...
class CapitalPageLocators:
    ...
    HEADER_OF_CAPITAL_COM = ".cc-header__wrap"
...
class SignupLoginFormLocators:
    ...
    BUTTON_CLOSE_ON_LOGIN_FORM = (By.CSS_SELECTOR, "#l_overlay > div > button.l_cansel")
    BUTTON_CLOSE_ON_SIGNUP_FORM = (By.CSS_SELECTOR, "#s_overlay > div > button.s_cancel")

    LIGIN_REF_SIGNUP_LOCATOR = (By.CSS_SELECTOR, "#l_overlay .l_btn_signup")
    LOGIN_INPUT_USERNAME = (By.CSS_SELECTOR, "")
    LOGIN_INPUT_PASSWORD = (By.CSS_SELECTOR, "")
    LOGIN_CHECKBOX_LOCATOR = (By.CSS_SELECTOR, "#l_overlay > div input[type=checkbox]")
    LOGIN_SUBMIT_BTN_LOCATOR = (By.CSS_SELECTOR, "#l_overlay form > button[type=submit]")
    SIGNUP_REF_LOGIN_LOCATOR = (By.CSS_SELECTOR, ".signup-form .l_btn_signup")
