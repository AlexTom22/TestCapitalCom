...
#
#
    @allure.feature("F_02 | Testing '1' tab 'Main' banner")
    @allure.story("S_02.01 | Testing 'Trade Now' button on the 1 tab 'Main' banner")
    @allure.step("Start test button 'Trade Now' on tab1 'Main' banner (for all License)")
    def test_02_01_banner_main_tab1_button_trade_now(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
    @allure.feature("F_02 | Testing '1' tab 'Main' banner")
    @allure.story("S_02.02 | Testing 'Practise for free' button on the 1 tab 'Main' banner")
    @allure.step("Start test button 'Practise for free' on tab1 'Main' banner (for all License)")
    def test_02_02_banner_main_tab1_button_practise_for_free(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
    @allure.feature("F_02 | Testing '1' tab 'Main' banner")
    @allure.story("S_02.03 | Testing 'Open account' button on the 1 tab 'Main' banner")
    @allure.step("Start test button 'Open account' on tab1 'Main' banner")
    def test_02_03_banner_main_tab1_button_open_account(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
#
    @allure.feature("F_03 | Testing '2' tab 'Main' banner")
    @allure.story("S_03.01 | Testing 'Take me there' button on the 2 tab 'Main' banner")
    @allure.step("Start test button 'Take me there' on tab2 'Main' banner (for all License)")
    def test_03_01_banner_main_tab2_button_take_me_there(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
    @allure.feature("F_03 | Testing '2' tab 'Main' banner")
    @allure.story("S_03.02 | Testing 'Start trading' button on the 2 tab 'Main' banner")
    @allure.step("Start test button 'Start trading' on tab2 'Main' banner")
    def test_03_02_banner_main_tab2_button_start_trading(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
    @allure.feature("F_03 | Testing '2' tab 'Main' banner")
    @allure.story("S_03.03 | Testing 'Practise for free' button on the 2 tab 'Main' banner")
    @allure.step("Start test button 'Practise for free' on tab2 'Main' banner")
    def test_03_03_banner_main_tab2_button_practise_for_free(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
#
    @allure.feature("F_04 | Testing '3' tab 'Main' banner")
    @allure.story("S_04.01 | Testing 'Learn more' button on the 3 tab (1 layout) 'Main' banner")
    @allure.step("Start test button 'Learn more' on tab3 'Main' banner (Layout 1: ASIC)")
    def test_04_01_banner_main_tab3_l1_button_learn_more_asic(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
    @allure.feature("F_04 | Testing '3' tab 'Main' banner")
    @allure.story("S_04.02 | Testing 'Start trading' button on the 3 tab (1 layout) 'Main' banner")
    @allure.step("Start test button 'Start trading' on tab3 'Main' banner (Layout 1: ASIC)")
    def test_04_02_banner_main_tab3_l1_button_start_trading_asic(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
    @allure.feature("F_04 | Testing '3' tab 'Main' banner")
    @allure.story("S_04.03 | Testing 'Start trading' button on the 3 tab (2 layout) 'Main' banner")
    @allure.step("Start test button 'Start trading' on tab3 'Main' banner (Layout 2: All License, except ASIC)")
    def test_04_03_banner_main_tab3_l2_button_start_trading_asic(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
    @allure.feature("F_04 | Testing '3' tab 'Main' banner")
    @allure.story("S_04.04 | Testing 'Practise for free' button on the 3 tab (2 layout) 'Main' banner")
    @allure.step("Start test button 'Practise for free' on tab3 'Main' banner (Layout 2: All, except ASIC)")
    def test_04_04_banner_main_tab3_l2_button_practise_fo_free_fca(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
#
    @allure.feature("F_05 | Testing '4' tab 'Main' banner")
    @allure.story("S_05.01 | Testing 'Explore features' button on the 4 tab 'Main' banner")
    @allure.step("Start test button 'Explore features' on tab4 'Main' banner (for {cur_license} License")
    def test_05_01_banner_main_tab4_button_explore_features(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
#
    @allure.feature("F_06 | Widget [Trading instrument]")
    @allure.story("S_06.01.01 | Widget [Trading instrument] tab [Most traded] button [Trade]")
    @allure.step("Start test 'Click 'Trade' buttons on the 'Most traded' tab 'Trading instrument' widget'")
    def test_06_01_01_widget_trading_instrument(
        self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
        ...
        if cur_language in [""]:
            if not (cur_license == "FCA" and tab_name == "Cryptocurrencies"):
                ...
                layout = page.what_is_the_current_layout()
                page.widget_trading_instrument_cur_tab_click(layout, tab_name)

                for line in range(7):
                    page = CapitalPage(d, test_link)
                    page.selected_tab_and_line_button_trade_click(layout, tab_name, line)
                    if cur_role == "NoReg":
                        page = SignupLoginForm(d, test_link)
                        page.should_be_signup_form()
                        page.close_signup_form()
...
#
    @allure.feature("F_06 | Widget [Trading instrument]")
    @allure.story("S_06.01.02 | Widget [Trading instrument] tab [Commodities] button [Trade]")
    @allure.step("Start test 'Click 'Trade' buttons on the 'Commodities' tab 'Trading instrument' widget'")
    def test_06_01_02_widget_trading_instrument(
        self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
        Check: widget "Trading instrument"
...
#
    @allure.feature("F_06 | Widget [Trading instrument]")
    @allure.story("S_06.01.03 | Widget [Trading instrument] tab [Indices] button [Trade]")
    @allure.step("Start test 'Click 'Trade' buttons on the 'Indices' tab 'Trading instrument' widget'")
    def test_06_01_03_widget_trading_instrument(
        self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
        Check: widget "Trading instrument"
...
#
    @allure.feature("F_06 | Widget [Trading instrument]")
    @allure.story("S_06.01.04 | Widget [Trading instrument] tab [Cryptocurrencies] button [Trade]")
    @allure.step("Start test 'Click 'Trade' buttons on the 'Cryptocurrencies' tab 'Trading instrument' widget'")
    def test_06_01_04_widget_trading_instrument(
        self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
        Check: widget "Trading instrument"
...
#
    @allure.feature("F_06 | Widget [Trading instrument]")
    @allure.story("S_06.01.05 | Widget [Trading instrument] tab [Shares] button [Trade]")
    @allure.step("Start test 'Click 'Trade' buttons on the 'Shares' tab 'Trading instrument' widget'")
    def test_06_01_05_widget_trading_instrument(
        self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
        Check: widget "Trading instrument"
...
#
    @allure.feature("F_06 | Widget [Trading instrument]")
    @allure.story("S_06.01.06 | Widget [Trading instrument] tab [Forex] button [Trade]")
    @allure.step("Start test 'Click 'Trade' buttons on the 'Forex' tab 'Trading instrument' widget'")
    def test_06_01_06_widget_trading_instrument(
        self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
        Check: widget "Trading instrument"
...
#
    @allure.feature("F_06 | Widget [Trading instrument]")
    @allure.story("S_06.01.07 | Widget [Trading instrument] tab [ETFs] button [Trade]")
    @allure.step("Start test 'Click 'Trade' button on the 'ETFs' tab 'Trading instrument' widget'")
    def test_06_01_07_widget_trading_instrument(
        self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
        Check: widget "Trading instrument"
...
#
#
    @allure.feature("F_07 | Testing 'Still looking for ...' widget")
    @allure.story("S_07.01 | Testing 'Create your account' button on the 'Still looking for ...' widget")
    @allure.step("Start tests of widget 'Still looking for a broker you can trust?'")
    def test_07_01_widget_still_looking_button_1_create_your_account(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
        ...
        if cur_language in [""]:
            if cur_license in ["ASIC", "FCA", "CYSEC", "NBRB", "CCSTV", "SEY"]:
                ...
                page.widget_still_looking_button_1_create_your_account_click()
...
#
#
    @allure.feature("F_08 | Testing 'Promo Market' widget")
    @allure.story("S_08.01 | Testing 'Trade Now' button on the 'Promo Market' widget")
    @allure.step("Run test for 'Promo Market' widget")
    def test_08_01_widget_promo_market_button_trade_now(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
#
    @allure.feature("F_09 | Testing 'Explore our platform' widget")
    @allure.story("S_09.01 | Testing 'Try now' button on the 'Explore our platform' widget")
    @allure.step("Run test for widget 'Explore our platform'")
    def test_09_01_widget_explore_our_platform(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
        ...
        if cur_language in [""]:
            if cur_license in ["ASIC", "FCA", "CYSEC", "NBRB", "CCSTV", "SEY"]:
                ...
                page.widget_explore_our_platform_button_tray_now_click()
...
#
#
    @allure.feature("F_10 | Testing 'New to trading?' widget")
    @allure.story("S_10.01 | Testing 'Practise for free' button on the 'Explore our platform' widget")
    @allure.step("Run test for widget 'New to trading?'")
    def test_10_01_widget_new_to_trading(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
        ...
        if cur_language in [""]:
            if cur_license in ["ASIC", "FCA", "CYSEC", "NBRB", "CCSTV", "SEY"]:
                ...
                assert \
                    page.widget_new_to_trading_button_practise_for_free_click(), \
...
#
#
    @allure.feature("F_11 | Testing 'Trading calculator' widget")
    @allure.story("S_11.01 | Testing 'Start trading' button on the 'Trading calculator' widget")
    @allure.step("Run test for button 'Start trading' for widget 'Trading calculator'")
    def test_11_01_widget_trading_calculator_button_start_trading(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
#
    @allure.feature("F_12 | Testing 'Trader's Dashboard' widget")
    @allure.story("S_12.01 | Testing 'Trade' button on the 'Trader's Dashboard' widget")
    @allure.step("Run test for buttons 'Trade' on 'Trader's Dashboard' widget")
    def test_12_01_widget_traders_dashboard_button_trade(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
...
#
#
    @allure.feature("F_13 | Testing 'Counters' banner")
    @allure.story("S_13.01 | Testing 'Try now' button on the 'Counters' banner")
    @allure.step("Test for 'Try now' button on banner with counters")
    def test_13_01_banner_of_counters_button_try_now(
            self, worker_id, d, cur_login, cur_password, cur_role, cur_language, cur_license
    ):
        """
